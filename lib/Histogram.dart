...
class Histogram {
  ...
  static final List<int> cekilenGoruntununHistogrami = List<int>.filled(256, 0);
  static int i = 0;

  static Future<void> CekilenGoruntununHistogram (String imagePath, int deger) async {
    ...
    for (int i = 0; i < (rgbaPixels.length).toInt(); i++) {
      ...
      cekilenGoruntununHistogrami[(luminance * 255).toInt()]++;
    }

    // Histogramı yazdırın veya başka bir şey yapın.
    print('Histogram: $cekilenGoruntununHistogrami');
    //return histogram;
  }

  static Future<Uint32List> pixelHesaplama1(String imagePath,int deger,int islem) async {
